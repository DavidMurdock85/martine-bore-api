var categories = {
  ...
  "new-arrivals": {
    ...
    breadcrumbs: [
      { url: "/", name: "Home" },
      { url: "/categories/new-arrivals", name: "New Arrivals" },
    ],
    list: [
      "french-empire-gilded-bronze-candle-sticks",
  ...
  clocks: {
    ...
    breadcrumbs: [
      { url: "/", name: "Home" },
      { url: "/categories/clocks", name: "Clocks" },
    ],
    list: [
      "clocks-ormolu-louis-xiv-french",
  ...
  georgian: {
    ...
    breadcrumbs: [
      { url: "/", name: "Home" },
      { url: "/categories/georgian", name: "Georgian" },
    ],
    list: [
  ...
  victorian: {
    ...
    breadcrumbs: [
      { url: "/", name: "Home" },
      { url: "/categories/victorian", name: "Victorian" },
    ],
    list: [
  ...
  "belle-epoque": {
    ...
    breadcrumbs: [
      { url: "/", name: "Home" },
      { url: "/categories/belle-epoque", name: "Belle Epoque" },
    ],
    list: [
  ...
  "art-nouveau": {
    ...
    breadcrumbs: [
      { url: "/", name: "Home" },
      { url: "/categories/art-nouveau", name: "Art Nouveau" },
    ],
    list: [
  ...
  "art-deco": {
    ...
    breadcrumbs: [
      { url: "/", name: "Home" },
      { url: "/categories/art-deco", name: "Art Deco" },
    ],
    list: [
      "art-deco-vase-enamel-glass-legras",
      "art-deco-mantle-clock-lepage-french",
      "art-deco-vases-royal-doulton-flambé",
  ...
  "modern-art": {
    ...
    breadcrumbs: [
      { url: "/", name: "Home" },
      { url: "/categories/modern-art", name: "Modern Art" },
    ],
    list: [
  ...
  "canadian-art": {
    ...
    list: [
      "canadian-art-pottery-owls-thomas-kakinuma",
      "canadian-art-paintings-panabaker-seascape",
      "canadian-art-watercolor-landscape-cabin-fall-norwell",
      "canadian-art-paintings-robert-lougheed-quebec-solitude",
      "canadian-art-pottery-owl-round-thomas-kakinuma",
      ...
      "canadian-art-pottery-owl-thomas-kakinuma",
  ...
  "dutch-art": {
    ...
    breadcrumbs: [
      { url: "/", name: "Home" },
      { url: "/categories/dutch-art", name: "Dutch Art" },
    ],
    list: [
      "dutch-art-paintings-pastoral-landscape-hague-school-barbizon-scherrewiz",
      "dutch-art-cut-crystal-covered-dishes-sterling-tops",
      "dutch-art-paintings-landscape-marinus-adrianus-koekkoek",
      "dutch-art-watercolor-cornelis-wouter-bouter",
      "dutch-art-centerpiece-pottery-gouda-art-nouveau",
      "dutch-art-silver-brandy-bowl",
      "dutch-art-vase-pottery-gouda-art-deco",
      "dutch-art-portraits-husband-wife",
    ],
  },

  // Art by Region - English Art
  ...
  "french-art": {
    ...
    breadcrumbs: [
      { url: "/", name: "Home" },
      { url: "/categories/french-art", name: "French Art" },
    ],
    list: [
  ...
  "german-art": {
    ...
    breadcrumbs: [
      { url: "/", name: "Home" },
      { url: "/categories/german-art", name: "German Art" },
    ],
    list: [
      "german-art-figurine-cherub-musician-dresden",
      "german-art-porcelain-vase-portrait-royal-bonn-pink",
      "german-art-paintings-portrait-regency-period",
      "german-art-dresden-floral-cherub-candelabra",
      "german-art-figurine-aristocrate-dresden",
      "german-art-pastels-portrait-prussian-officer",
      "german-art-figurines-jester-dresden-carl-thieme",
      "german-art-figurines-musician-chiniosere-royal-kpm",
      "german-art-paintings-portrait-young-man-hat",
    ],
  },

  // Art by Region - Italian Art
  ...
  "italian-art": {
    ...
    breadcrumbs: [
      { url: "/", name: "Home" },
      { url: "/categories/italian-art", name: "Italian Art" },
    ],
    list: [
      "",
      "",
  ...
  "japanese-art": {
    ...
    list: [
      ...
      "japanese-art-netsuke-ivory-kagamibuta",
      "japanese-art-netsuke-oni-fishing-ivory",
      "japanese-art-netsuke-taiko-drummer-ivory",
      "japanese-art-netsuke-noh-masks-ivory",
      "japanese-art-netsuke-mice-gourd-ivory",
      "japanese-art-netsuke-porcelain-hirado-mikan",
      "japanese-art-netsuke-fishermen-ivory",
      "japanese-art-netsuke-ivory-coral-rabbits",
      "japanese-art-netsuke-floral-arrangment-ivory",
      "japanese-art-netsuke-assorted-objects-ivory",
      "japanese-art-netsuke-child-tiger-ivory",
      "japanese-art-netsuke-ivory-shitake-mushrooms",
      "japanese-art-netsuke-men-smoking-pipes-ivory",
      "japanese-art-netsuke-man-shishi-ivory",
      "japanese-art-netsuke-otedama-wood",
      "japanese-art-netsuke-wood-clam-shell",
      "japanese-art-netsuke-shishi-wood",
      "japanese-art-netsuke-yokai-wood",
      "japanese-art-netsuke-mice-wood-coral",
      "japanese-art-netsuke-obasan-wood",
  ...
  plates: {
    ...
    breadcrumbs: [
      { url: "/", name: "Home" },
      { url: "/categories/plates", name: "Plates" },
    ],
    list: [
  ...
  stemware: {
    ...
    breadcrumbs: [
      { url: "/", name: "Home" },
      { url: "/categories/stemware", name: "Stemware" },
    ],
    list: [
      "stemware-glasses-dessert-waterford-clarendon",
      ...
      "stemware-glasses-sterling-english",
    ],
  },
  ...
  "tea-service": {
    ...
    breadcrumbs: [
      { url: "/", name: "Home" },
      { url: "/categories/tea-service", name: "Tea Service" },
    ],
    list: [
  ...
  rings: {
    ...
    breadcrumbs: [
      { url: "/", name: "Home" },
      { url: "/categories/rings", name: "Rings" },
    ],
    list: [
  ...
  bracelets: {
    ...
    breadcrumbs: [
      { url: "/", name: "Home" },
      { url: "/categories/bracelets", name: "Bracelets" },
    ],
    list: [
      "bracelets-chain-link-opal-citrine-gold",
      "bracelets-pearls-sapphires-gold",
      "bracelets-seed-pearls-rubies-gold",
  ...
  necklaces: {
    ...
    breadcrumbs: [
      { url: "/", name: "Home" },
      { url: "/categories/necklaces", name: "Necklaces" },
    ],
    list: [
  ...
  brooches: {
    ...
    breadcrumbs: [
      { url: "/", name: "Home" },
      { url: "/categories/brooches", name: "Brooches" },
    ],
    list: [
      "brooches-cameo-coral-gold-italy",
      "brooches-flower-emerald-white-gold",
      "brooches-bar-pin-aquamarine-diamonds-edwardian",
      "brooches-coral-diamonds-pearls-victorian",
